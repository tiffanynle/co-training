...
# taken from here
# https://github.com/Jonathan-Pearce/calibration_library
...
#ACE but take the max of the bins
class MACELoss(CELoss):
    def loss(self, output, labels, threshold = 0.00, n_bins = 15, logits = True):
        self.n_bins = n_bins
        self.n_data = len(output)
        self.n_class = len(output[0])
